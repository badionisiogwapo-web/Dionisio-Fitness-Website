...
<main>
    <section class="page-banner">
        <div class="page-banner-content reveal">
            <p class="eyebrow">ABOUT DIONISIO</p>
            <h1>BUILT FOR <span>YOU.</span></h1>
            <p>A place built around discipline, consistency and progress.</p>
        </div>
    </section>
...
<section class="section dark-section">
    <div class="section-heading centered reveal">
        <p class="eyebrow">THE DIONISIO WAY</p>
        <h2>FOCUS. <span>TRAIN.</span> CONQUER.</h2>
    </div>
    <div class="three-columns">
        <div class="simple-feature reveal"><b>01</b><h3>DISCIPLINE</h3><p>Show up and do the work.</p></div>
        <div class="simple-feature reveal"><b>02</b><h3>CONSISTENCY</h3><p>Keep moving forward one workout at a time.</p></div>
        <div class="simple-feature reveal"><b>03</b><h3>PROGRESS</h3><p>Become stronger through steady effort.</p></div>
    </div>
</section>
